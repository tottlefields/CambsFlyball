...
function get_stats_for_dog($dog_id, $name){
	...
	return $wpdb->get_results("select dog_id, post_title as event_title, post_name as slug, points, heats, t1.fastest_time, average_time, consistency, t1.new_fastest,
