				...
				<div class="row">
					...
					?>
						...
						<?php if (get_post_meta( $comp->ID, 'w3w', true ) != '') { 
							echo '<a href="https://map.what3words.com/'.str_replace('///', '', get_post_meta( $comp->ID, 'w3w', true )).'"><img src="'.get_stylesheet_directory_uri().'/assets/images/w3w.png" style="width:25%;box-shadow: none;" /></a>';
						} ?>
									</th>
						<?php endforeach;?>
									</tr>
