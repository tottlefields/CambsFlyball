...
class flyball_seedings_widget extends WP_Widget {
         ...
         public function __construct() {
			...
			/* Create the widget. */
			parent::__construct( 'widget-front-page-text', __('Flyball Current Seedings', 'cambs-flyball'), $widget_ops, $control_ops );		
